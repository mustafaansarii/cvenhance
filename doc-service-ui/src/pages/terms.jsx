        ...
        <>
            ...
            >
                ...
                <PageHero
                    ...
                    description="The terms that govern your use of NextCV."
                />
            </div>
            ...
            <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
                ...
                <p className="mt-6 text-sm leading-relaxed text-slate-700">
                    These Terms &amp; Conditions (&ldquo;Terms&rdquo;) govern your access to and use of NextCV
                    (the &ldquo;Service&rdquo;), operated by MUSTAFA ANSARI (&ldquo;we&rdquo;,
                ...
                <Section title="2. The Service">
                    <p>
                        NextCV lets you build, edit and download resumes and related documents. You retain
